        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-4 w-full">
              {/* QR Code */}
              <div className="w-36 h-36 bg-white border-2 border-[#25D366]/30 relative flex items-center justify-center p-2 shadow-[4px_4px_0_rgba(37,211,102,0.1)] rounded-xl shrink-0">
                <img src="/whatsapp.png" alt="WhatsApp Group QR Code" className="max-w-full max-h-full object-contain mx-auto block" />
              </div>

              {/* Link Button */}
              <a 
                href="https://chat.whatsapp.com/LNQgfbJTUJl2alPA29xumf?mode=gi_t" 
                target="_blank" 
                rel="noopener noreferrer"
                className="group flex flex-col items-center justify-center bg-[#25D366]/10 border-2 border-[#25D366]/30 rounded-xl p-4 shadow-[4px_4px_0_rgba(37,211,102,0.1)] hover:bg-[#25D366]/20 transition-all hover:-translate-y-1 w-full max-w-[200px]"
              >
                <div className="w-12 h-12 bg-[#25D366] rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(37,211,102,0.5)]">
                ...
                <span className="text-white font-bold text-sm tracking-wider uppercase text-center">Join Group</span>
                <span className="text-[#25D366] text-[10px] mt-1 uppercase tracking-widest text-center">Click to Open</span>
              </a>
            </div>
            
            <p className="text-xs text-on-surface-variant text-center max-w-[80%] uppercase tracking-widest leading-relaxed mt-2 items-center flex justify-center">
              Scan the code or click the button above to join the official alert channel.
            </p>
          </motion.div>
        );
      case 6:
